        ...
        <section id="gallery" className="py-20 bg-primary-50">
            <div className="container mx-auto px-4 md:px-6">
                <div className="text-center mb-16">
                    <h2 className="text-3xl md:text-4xl font-serif font-bold text-secondary-900 mb-4">Our Masterpieces</h2>
                    <div className="w-20 h-1 bg-primary-400 mx-auto rounded-full"></div>
                    <p className="mt-4 text-gray-600 max-w-2xl mx-auto">
                        Browse through our portfolio of stunning nail art and transformations.
                    </p>
                </div>
