                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            ...
                            <li><a href="#services" className="text-gray-400 hover:text-primary-400 transition-colors">{t('footer.services')}</a></li>
                            <li><a href="#gallery" className="text-gray-400 hover:text-primary-400 transition-colors">{t('footer.gallery')}</a></li>
                            <li><a href="#booking" className="text-gray-400 hover:text-primary-400 transition-colors">{t('footer.bookAppointment')}</a></li>
                        </ul>
                    </div>
